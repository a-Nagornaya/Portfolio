...
<pre><code>
	...
	FROM EMPLOYEES;
	/* выбераю наименьшее целое число (сeil), полученное в результате вычитания из среднего арифметического (avg) фактической ЗП и среднего арифметического введенной ЗП, но где 0 замененн на ' '(replace)*/
</code></pre>
<details>
...
<pre><code>
	...
	SALARY > 2000 AND MONTHS < 10
		...
		/* выбераю имена сотрудников, которые соответствуют условиям и сортирую по ID, условия сортировки дополнительно не прописываю, так как по умолчанию сортировка будет нужная
		*/
</code></pre>
<summary>Скрин задачи</summary>
	<img src='https://github.com/a-Nagornaya/Portfolio/blob/main/%D0%A1%D0%BD%D0%B8%D0%BC%D0%BE%D0%BA%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202023-09-28%20094013.png'>
